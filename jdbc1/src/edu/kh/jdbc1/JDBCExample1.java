...
public class JDBCExample1 {
	public static void main(String[] args) {
		...
		try {
			...
			// url == jdbc:oracle:thin:@localhost:1521:XE
			// java랑 db가 연결된 통로가 열림
			
			
			// 중간확인
			// System.err.println(conn); // oracle.jdbc.driver.T4CConnection@72d1ad2e
